        ...
        <div className="container">
          ...
          <div className="col">
            ...
            >
              ...
              curious, exact at the time we left the service, without a doubt if
              I needed him again I would do the work with him, thank you very
              much"
            </p>
            <footer className="footer" style={{ color: "white" }}>
              {" "}
          ...
          <div className="col">
            ...
            >
              ...
              glass very quickly, and the next day he said that he would arrive
              at 8.30am. And so it happened!!! He arrived exactly at 8.30, I
              didn’t have to wait for him. I recommend this service to
              everyone."
            </p>
            <footer className="footer" style={{ color: "white" }}>
              {" "}
